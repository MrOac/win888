...
export default class PopupSecurity extends Dialog {
        ...
        MiniGameNetworkClient.getInstance().addListener((data) => {
            ...
            switch (inpacket.getCmdId()) {
                ...
                case cmd.Code.CHANGE_PHONE_NUMBER: {
                    ...
                    this.showSmsPlusContinue();
                    App.instance.alertDialog.showMsg("សូមបញ្ចូល OTP (លេខទូរស័ព្ទចាស់) ដើម្បីបន្តផ្លាស់ប្តូរលេខទូរស័ព្ទសុវត្ថិភាព!");
                    break;
                }
                ...
                case cmd.Code.RESULT_ACTIVE_NEW_MOBILE: {
                    ...
                    if (res.error == 0) {
                        LogEvent.getInstance().sendEventSdt(this.panelSmsPlus.updateEdbPhoneNumber.string.trim());
                        App.instance.alertDialog.showMsg("ផ្លាស់ប្តូរលេខទូរសព្ទ និងបើកដំណើរការសុវត្ថិភាពដោយជោគជ័យ!");
                        this.onTabChanged();
                    } else {
                        App.instance.alertDialog.showMsg("ប្រតិបត្តិការបានបរាជ័យ សូមព្យាយាមម្តងទៀតនៅពេលក្រោយ!");
                    }
                ...
                case cmd.Code.RESULT_CHANGE_MOBILE_ACTIVED: {
                    ...
                    if (res.error == 0) {
                        this.showSmsPlusContinue();
                        App.instance.alertDialog.showMsg("សូមបញ្ចូល OTP (លេខទូរស័ព្ទថ្មី) ដើម្បីបញ្ចប់ការផ្លាស់ប្តូរលេខទូរសព្ទសុវត្ថិភាព!");
                    } else {
                        App.instance.alertDialog.showMsg("ប្រតិបត្តិការបានបរាជ័យ សូមព្យាយាមម្តងទៀតនៅពេលក្រោយ!");
                    }
                    break;
    ...
    actTeleSafe() {
        ...
        App.instance.confirmDialog.show2(App.instance.getTextLang('txt_check_teleSafe'), () => {
            cc.sys.openURL("https://www.telegram.me/joker_123_bot?start=" + Configs.Login.AccessToken + "-" + Configs.Login.Nickname);
        })
    }
