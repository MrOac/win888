...
export default class UIItemDiemDanh extends cc.Component {
    ...
    getDescription(gameId) {
        ...
        switch (gameId) {
            case 191:
                des = "ភ្នាល់ផ្លែឈើសរុប 200k ទទួលបានការបង្វិល 1 រាំ 100";
                break;
            case 170:
                des = "ការភ្នាល់សរុប រាំ 200k ទទួលបានការបង្វិល 1 ដំណើរទៅកាន់ទិសខាងលិច 100";
                break;
            case 110:
                des = "ការភ្នាល់សរុបលើ Journey to the West 200k ទទួលបាន 1 NightClub spin 100";
                break;
            case 160:
                des = "NightClub ភ្នាល់សរុប 200k ទទួលបាន 1 ការបង្វិលបាល់ទាត់ 100";
                break;
            case 150:
                des = "ការភ្នាល់បាល់ទាត់សរុប 200k ទទួលបាន 1 Night Club បង្វិល 100";
                break;
            case 180:
                des = "ភ្នាល់សរុប Battle Of Gods 200k ទទួលបាន 1 spin Dance 100";
                break;
                break;
        }
        return des;
