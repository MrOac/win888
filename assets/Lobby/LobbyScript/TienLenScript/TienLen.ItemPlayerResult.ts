            ...
            switch (data.winTypes) {
                ...
                case 9:
                    if (data.winTypes == 3) {
                        ...
                        this.labelFx.string = "ចាប់បានផ្អាក";
                ...
                case 11:
                    ...
                    if (this.kiemtraThoiTuQuy(data.cards)) {
                        ...
                        this.labelFx.string = "បួនភាគបួនរលួយ";
            ...
            switch (data.winTypes) {
                ...
                case 9:
                    if (data.winTypes == 3) {
                        this.fxResult.active = true;
                        //this.labelFx.font = this.fontFx[0];
                        this.labelFx.string = "ឈ្នះ SAM";
                    } else if (data.winTypes == 4) {
                        this.fxResult.active = true;
                        //this.labelFx.font = this.fontFx[0];
                        this.labelFx.string = "ប្លុក SAM";
                    } else {
                        this.fxResult.active = true;
                        //this.labelFx.font = this.fontFx[0];
                        this.labelFx.string = "ទៅ ស";
                    }
                    break;
                case 11:
                case 12:
                ...
                case 16:
                    ...
                    this.fxResult.active = true;
                    //this.labelFx.font = this.fontFx[1];
                    this.labelFx.string = "បានទប់ស្កាត់ SAM";
                    break;
                default:
                    break;
            }
