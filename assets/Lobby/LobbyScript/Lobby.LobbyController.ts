    ...
    export class LobbyController extends cc.Component {
        ...
        onLoad() {
            ...
            this.buttonjb.on(cc.Node.EventType.TOUCH_END, (event: cc.Event.EventTouch) => {
                ...
                let posX = this.buttonjb.x > 0 ? cc.winSize.width / 2 - 304 : -cc.winSize.width / 2 + 122;
        ...
        actPlaynow(): void {
            this.deviceID = cc.sys.localStorage.getItem("bitjackpot-deviceid")
        ...
        actShareFbLink(link) {
            ...
            FB.ui({
                ...
                method: 'share',
                href: link,
                caption: 'ក្លាយជាអ្នកមានជាមួយ bitjackpot'
            }, function (response) {
        ...
        actOpenLive() {
            ...
            //App.instance.openWebView("https://bitjackpot.io");
        }
