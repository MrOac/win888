...
export default class BaiCaoController extends cc.Component {
    ...
    setupMatch(data: cmd.ReceivedJoinRoomSucceed) {
        ...
        this.labelRoomId.string = "កាតកោស - បន្ទប់: " + roomId;
    ...
    openMeCard(event, itemId) {
        ...
        if (this.numCardOpened == 3) {
            ...
            this.getPlayerHouse(0).showCardName(this.getCardsScore(this.currentCard) + " ចំណុច");
                ...
                case cmd.Code.JOIN_ROOM_FAIL:
                    {
                        ...
                        switch (res.getError()) {
                            case 1:
                                ...
                                break;
                            case 2:
                                msg = "រកមិនឃើញបន្ទប់សមរម្យទេ។ សូម​ព្យាយាម​ម្តង​ទៀត​នៅ​ពេល​ក្រោយ!";
                                break;
                            case 3:
                ...
                case cmd.Code.MO_BAI:
                    {
                        ...
                        if (seatId != -1 && seatId != 0) {
                            ...
                            this.getPlayerHouse(seatId).showCardName(this.getCardsScore(cards) + " ចំណុច");
                        }
                ...
                case cmd.Code.KET_THUC:
                    {
                        ...
                        for (let index = 0; index < 8; index++) {
                            ...
                            if (findId !== -1) {
                                ...
                                this.getPlayerHouse(index).showCardName(this.getCardsScore(cards) + " ចំណុច");
                ...
                case cmd.Code.THONG_TIN_BAN_CHOI:
                    {
                        ...
                        this.labelRoomId.string = "BÀI CÀO - បន្ទប់: " + roomId;
                        this.labelRoomBet.string = "កម្រិតភ្នាល់: " + Utils.formatNumber(moneyBet) + "$";
    ...
    actionDanhBien(event, id) {
        ...
        if (pos != -1) {
            ...
            //  cc.log("BaiCao actionDanhBien ------------");
            this.getPlayerHouse(seatId).disableDanhBien(level);
            this.getPlayerHouse(seatId).showNotify("ការភ្នាល់តាមព្រំដែន");
