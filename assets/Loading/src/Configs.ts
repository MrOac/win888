...
namespace Configs {
    ...
    export class App {
        // 43.128.27.35
        public static NAME_APP = "win888";
        public static IS_LOCAL = false;
        public static IS_PRO = true;
        static API: string = "https://iportal.bitjackpot.io/api";
		static API2: string = "https://iportal2.bitjackpot.io/api";
		static APIROY: string = "https://portal.bitjackpot.io/api";
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.bitjackpot.io/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://bitjackpot.io/download";
        static LINK_EVENT = "https://bitjackpot.io/event";
        static LINK_SUPPORT = "https://bitjackpot.io";
        static USE_WSS = false;
        static LINK_GROUP = "https://www.facebook.com/groups/bitjackpot";
        ...
        static readonly HOST_SOCKJS = "https://st.bitjackpot.io/";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/bitjackpot";
            }
        }
